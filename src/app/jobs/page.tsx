...
<form onSubmit={searchSubmit} className="flex items-center flex-col gap-y-5 justify-center flex-wrap">   
    ...
    <div className="relative w-32 sm:w-40">
        ...
        <input type="text" value={country} onChange={(e:any)=>setcountry(e.target.value)} id="voice-search" className="bg-gray-50 border border-gray-300 text-gray-900 text-xs sm:text-sm rounded-md  focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Country name" />
    ...
    <div className="relative w-36 sm:w-52">
        ...
        <input type="text" value={title} onChange={(e:any)=>settitle(e.target.value)} id="voice-search" className="rounded-md bg-gray-50 border border-gray-300 text-gray-900 text-xs sm:text-sm focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Job Title or Keyword" />
    ...
    <div className="relative w-32 sm:w-40">
        ...
        <input type="text" value={city} onChange={(e:any)=>setcity(e.target.value)} id="voice-search" className="bg-gray-50 border border-gray-300 text-gray-900 text-xs sm:text-sm rounded-md  focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="City or State" />
...
<select id="date"  onChange={(e:any)=>setpostingdate(e.target.value)}   className='border-2 text-sm rounded-lg border-emerald-500 mt-2 outline-none'>
...
<select id="requirements" onChange={(e:any)=>setRequirement(e.target.value)}  className='border-2 text-sm rounded-lg border-emerald-500 mt-2 outline-none'>
...
<select id="remote"  onChange={(e:any)=>setjobtype(e.target.value)}  className='border-2 text-sm rounded-lg border-emerald-500 mt-2 outline-none'>
  <option selected value="false">OnSite</option>
  <option value="true">Remote</option>
</select>
    </div>
    <div className='flex flex-col'>
    <label htmlFor="employment" className='font-semibold'>Employment</label>
<select id="employment"  onChange={(e:any)=>setemployment(e.target.value)}  className='border-2 text-sm rounded-lg border-emerald-500 mt-2 outline-none'>
